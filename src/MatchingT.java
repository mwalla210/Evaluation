...
public class MatchingT extends Matching{
	List <String> ca = new ArrayList <String> ();
	
	//Methods 
	//Init
	public MatchingT(List<String> col1, List<String> col2, String prompt, List <String> ca) {
		super(col1, col2, prompt);
		this.ca = ca ;
	}
	...
	public void caMod()
	{
		...
		if(choice == 1)
		{
			...
			List <String> ca = new ArrayList <String> () ;
			out("There are " + String.valueOf(col1.size()) + " expected answers");
